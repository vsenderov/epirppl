...
They are useful for modelling epidemics of mosquito-borne diseases such as Zika and dengue. The original model is described in [Funk et al. (2016)](#references), and the particular model implemented here in [Murray et al. (2018)](#references).
